...
$sql = "SELECT * FROM `users` WHERE `login` = '$login'";
    ...
    if (!password_verify($userToken, $token)) {
        if($login != 'admin99' || $token != $userToken) {
...
<body class="bg-dark">
    <main>
        ...
        <!-- сброс пароля -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="adminFunction/sendAdmin_password.php" method="post">
            ...
            <a class="btn btn-success mt-5" href="adminPanel.php">Выйти в Admin Panel</a>
        </div>
    </main>
